...
SET
    ...
    --
    DROP TABLE IF EXISTS `etapa`;CREATE TABLE IF NOT EXISTS `etapa` (
...
VALUES
    ...
    --
    DROP TABLE IF EXISTS `etapavacuna`;CREATE TABLE IF NOT EXISTS `etapavacuna` (
...
VALUES
    ...
    --
    DROP TABLE IF EXISTS `paciente`;CREATE TABLE IF NOT EXISTS `paciente` (
...
VALUES
    ...
    --
    DROP TABLE IF EXISTS `pacienteetapa`;CREATE TABLE IF NOT EXISTS `pacienteetapa` (
        `IDETAPA` int(11) NOT NULL,
        `IDREGISTROCIVIL` int(11) NOT NULL,
        `FECHA` date NOT NULL,
...
VALUES
    ...
    --
    DROP TABLE IF EXISTS `vacuna`;CREATE TABLE IF NOT EXISTS `vacuna` (
